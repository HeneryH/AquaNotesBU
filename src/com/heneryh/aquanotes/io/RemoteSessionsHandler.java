...
import com.heneryh.aquanotes.util.Lists;
import com.heneryh.aquanotes.util.ParserUtils;
import com.heneryh.aquanotes.util.SpreadsheetEntry;
...
import static com.heneryh.aquanotes.util.ParserUtils.sanitizeId;
import static com.heneryh.aquanotes.util.ParserUtils.splitComma;
import static com.heneryh.aquanotes.util.ParserUtils.translateTrackIdAlias;
import static com.heneryh.aquanotes.util.ParserUtils.AtomTags.ENTRY;
...
public class RemoteSessionsHandler extends XmlHandler {
    ...
    public RemoteSessionsHandler() {
        super(AquaNotesDbContract.CONTENT_AUTHORITY);
    }
    ...
    private static ContentValues querySessionDetails(Uri uri, ContentResolver resolver) {
        ...
        try {
            if (cursor.moveToFirst()) {
                ...
                values.put(SyncColumns.UPDATED, AquaNotesDbContract.UPDATED_NEVER);
            }
        } finally {
            cursor.close();
        }
