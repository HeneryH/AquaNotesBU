...
import com.heneryh.aquanotes.ui.widget.BlocksLayout;
...
public class ScheduleFragment extends Fragment implements
    ...
    private void setupDay(LayoutInflater inflater, long startMillis) {
        ...
        day.blocksUri = AquaNotesDbContract.Blocks.buildBlocksBetweenDirUri(
    ...
    private void requery() {
        for (Day day : mDays) {
            mHandler.startQuery(0, day, day.blocksUri, BlocksQuery.PROJECTION,
                    null, null, AquaNotesDbContract.Blocks.DEFAULT_SORT);
        }
    }
    ...
    private interface BlocksQuery {
        String[] PROJECTION = {
                BaseColumns._ID,
                AquaNotesDbContract.Blocks.BLOCK_ID,
                AquaNotesDbContract.Blocks.BLOCK_TITLE,
                AquaNotesDbContract.Blocks.BLOCK_START,
                AquaNotesDbContract.Blocks.BLOCK_END,
                AquaNotesDbContract.Blocks.BLOCK_TYPE,
                AquaNotesDbContract.Blocks.SESSIONS_COUNT,
                AquaNotesDbContract.Blocks.CONTAINS_STARRED,
        };
