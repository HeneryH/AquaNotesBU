...
public class SessionDetailFragment extends Fragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSessionId = AquaNotesDbContract.Sessions.getSessionId(mSessionUri);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        final Uri speakersUri = AquaNotesDbContract.Sessions.buildSpeakersDirUri(mSessionId);
    ...
    private Uri resolveTrackUri(Intent intent) {
        ...
        if (trackUri != null) {
            ...
            return AquaNotesDbContract.Sessions.buildTracksDirUri(mSessionId);
        }
    }
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        values.put(AquaNotesDbContract.Sessions.SESSION_STARRED, isChecked ? 1 : 0);
    ...
    private interface SessionsQuery {
        ...
        String[] PROJECTION = {
                ...
                AquaNotesDbContract.Sessions.SESSION_LEVEL,
                AquaNotesDbContract.Sessions.SESSION_TITLE,
                AquaNotesDbContract.Sessions.SESSION_ABSTRACT,
                AquaNotesDbContract.Sessions.SESSION_REQUIREMENTS,
                AquaNotesDbContract.Sessions.SESSION_STARRED,
                AquaNotesDbContract.Sessions.SESSION_HASHTAG,
                AquaNotesDbContract.Sessions.SESSION_SLUG,
                AquaNotesDbContract.Sessions.SESSION_URL,
                AquaNotesDbContract.Sessions.SESSION_MODERATOR_URL,
                AquaNotesDbContract.Sessions.SESSION_YOUTUBE_URL,
                AquaNotesDbContract.Sessions.SESSION_PDF_URL,
                AquaNotesDbContract.Sessions.SESSION_FEEDBACK_URL,
                AquaNotesDbContract.Sessions.SESSION_NOTES_URL,
                AquaNotesDbContract.Sessions.ROOM_ID,
    ...
    private interface SpeakersQuery {
        ...
        String[] PROJECTION = {
                AquaNotesDbContract.Speakers.SPEAKER_NAME,
                AquaNotesDbContract.Speakers.SPEAKER_IMAGE_URL,
                AquaNotesDbContract.Speakers.SPEAKER_COMPANY,
                AquaNotesDbContract.Speakers.SPEAKER_ABSTRACT,
                AquaNotesDbContract.Speakers.SPEAKER_URL,
        };
