...
public class TracksAdapter extends CursorAdapter {
    ...
    public interface TracksQuery {
        ...
        String[] PROJECTION = {
                BaseColumns._ID,
                AquaNotesDbContract.Tracks.TRACK_ID,
                AquaNotesDbContract.Tracks.TRACK_NAME,
                AquaNotesDbContract.Tracks.TRACK_ABSTRACT,
        ...
        String[] PROJECTION_WITH_SESSIONS_COUNT = {
                ...
                AquaNotesDbContract.Tracks.TRACK_ABSTRACT,
                AquaNotesDbContract.Tracks.TRACK_COLOR,
                AquaNotesDbContract.Tracks.SESSIONS_COUNT,
        };
        ...
        String[] PROJECTION_WITH_VENDORS_COUNT = {
                ...
                AquaNotesDbContract.Tracks.TRACK_ABSTRACT,
                AquaNotesDbContract.Tracks.TRACK_COLOR,
                AquaNotesDbContract.Tracks.VENDORS_COUNT,
        };
